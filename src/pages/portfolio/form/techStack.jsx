...
import { authGetHome, createTechStack } from "@/redux/actions/portfolioActions";
...
const TechStack = () => {
  ...
  useEffect(() => {
    ...
    if (techStackCreated) {
      showAlert("Tech Stack created successfully", "success");
      dispatch(resetTechStack());
      router.push("/auth/profile");
    }
  }, [error, error2, techStackCreated, router, dispatch, showAlert]);
      ...
      {!user?.uid || loading ? (
        ...
        <>
          <div className='px-[20px] pb-[30px] pt-[80px] m-auto min-h-[100vh] md:w-[600px]'>
            {/* Form Heading */}
            <h2 className='text-3xl text-center mb-3'>Create Tech Stack</h2>
